import { validateDate,validateGuests, validateTime } from "../Components/BookingForm/validators";
...
describe("validateGuests",()=>{
    ...
    test.each(outOfRangeValues)("should return invalid result given %d",(input)=>{
...
describe("validateTime",()=>{
    const validTimes = ["17:00", "05:00","5:00", "22:30", "10:01","00:00","0:00"];
